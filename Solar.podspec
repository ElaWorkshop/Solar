...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Chris Howell"
  # s.authors            = { "Chris Howell" => "chris.kevin.howell@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Chris Howell"
  ...
  s.source_files  = "Solar/Solar/*.{swift}"
